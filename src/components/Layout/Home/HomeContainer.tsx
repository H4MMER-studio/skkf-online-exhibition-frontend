...
const HomeContainer: React.FC<IProps> = ({ isUnmountHome, onClickDesigner }) => {
    ...
    const debouncedRow = useDebounce(row, 400);
    const debouncedColumn = useDebounce(column, 400);
                ...
                <LogoLayout>
                    ...
                    <RowColumnLocationLayout>
                        <TestLayout>
                            ...
                            <CommaImage
                                src={"/image/comma.svg"}
                                commaState={selectedColmnImageList.length > 0 && selectedRowImageList.length > 0}
                            />
