    ...
    <STDCelebrationContainer>
      ...
      <DescriptionLayout headHeight={headHeight}>
        ...
        <MainText>
          ...
          <br />
          <br /> 이번 행사가 있기까지 헌신적으로 지도해 주신 학과의 교수님들,
          각별한 사랑과 관심으로 지원을 아끼지 않으시는 학생의 가족분들, 그리고
          이번 작품전에 관심을 쏟아 주신 모든 분들께 감사의 말씀을 전합니다.
          졸업생 여러분들의 앞날에 발전과 행복이 가득하기를 기원합니다.
        </MainText>
        <br />
        <EndText>
        ...
        <MainText>
          ...
          <br />
          <br /> 예술대학 의상학과 학생 여러분들은 졸업작품을 준비하고
          발표하기까지의 긴 과정 속에서 수많은 난관에 부딪혔을 것입니다. 하지만
          이러한 위기들을 이겨내며, 그 노력의 결과물을 글로벌하게 공유할 수 있는
          컨텐츠를 제작함으로써 모두가 스스로의 성장에 한 발 더 다가섰을
          것이라고 기대합니다. 이처럼 학생들이 저마다 택하여 걸어온 배움의
          결과로서 발표하는 졸업작품을 감상하는 것은 항상 설레는 일이며, 쉽지
          않았을 시도를 성공적으로 마무리했다는 사실이 자랑스럽습니다.
          <br />
        ...
        <MainText>
          ...
          박수를 보냅니다.
          <br />
          <br /> 그동안 열과 성의를 다해 이번 예비 졸업생들을 지도해주신 조경숙,
          장성은 교수님을 비롯한 학과 교수님들과 지금까지 우리 학생들을
          물심양면으로 지원해 주신학부모님들, 작품전을 위해 지원과 협조를
          보내주신 모든 관계자분들께 깊이 감사드립니다.
          <br />
          <br /> 마지막으로 이번 작품전을 위해 어려운 시간 속에서도 밤낮으로
          최선올 다해 준비하며 졸업올 앞두게 된 여러분 모두에게 아름답고 멋진
          미래가 펼쳐지기를 진심으로 기원합니다.
        </MainText>
        <br />
        <EndText>
          <span className="eng_style">2022.06.10</span>
        ...
        <MainText>
          코로나 팬데믹이 모든 이들에게 많은 변수와 혼란을 안겨 준지 어언 3년째,
          잃어버렸던 캠퍼스 라이프를 되찾고 예전처럼 졸업 패션쇼를 꿈꾸었으나
          올해에도 패션 필름으로 마주하게 되었습니다. 어려운 상황 속에서 디자인
          작업과 작품 실물 제작만 해도 학생 개개인들에게 큰 도전이었지만, 작품을
          영상으로 연출하고 온라인 공간에서 기록하는 것 또한 많은 용기가
