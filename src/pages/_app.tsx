...
function MyApp({ Component, pageProps }: AppProps) {
    ...
    return (
        <>
            <Head>
                <meta content="성균관 대학교 온라인 졸업 전시회" name="description" key="description" />
                <meta content="성균관 대학교 온라인 졸업 전시회" property="og:description" key="og:description" />
                <meta content="성균관 대학교 온라인 졸업 전시회" name="twitter:description" key="twitter:description" />
                <meta
