...
function MyApp({ Component, pageProps }: AppProps) {
    ...
    return (
        <>
            <Head>
                <meta content="성균관대학교 예술대학 의상학과 졸업패션필름" name="description" key="description" />
                <meta
                ...
                <meta property="og:image" content="https://2022skkfdoc.com/meta-img.pn" />
                <meta property="og:url" content="https://2022skkfdoc.com" />

                <title>Origin of Coordinate</title>
                <meta content="origin of coordinate" property="og:title" key="og:title" />
                <meta content="origin of coordinate" name="twitter:title" key="twitter:title" />
                <meta content="origin of coordinate" name="author" key="author" />
                <meta content="origin of coordinate" property="og:site_name" key="og:site_name" />
            ...
            <STDContainer height={height}>
                ...
                <Component {...pageProps} isUnmountHome={isUnmountHome} onClickDesigner={onClickDesigner} />
            </STDContainer>
        </>
    );
}
